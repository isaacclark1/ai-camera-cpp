...
/**
 * HailoTensor wraps around the raw output data from a Hailo neural network.
 * It stores both the actual data (as a pointer) and important metadata about the tensor.
 */
class HailoTensor
{
private:
